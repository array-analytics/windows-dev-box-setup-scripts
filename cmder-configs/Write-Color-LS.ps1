...
New-CommandWrapper Out-Default -Process {
  ...
  $executable = New-Object System.Text.RegularExpressions.Regex('\.(exe|bat|cmd|msi|ps1|psm1|vbs|reg)$', $regex_opts)
  $dll = New-Object System.Text.RegularExpressions.Regex('\.(dll)$', $regex_opts)
  $text_files = New-Object System.Text.RegularExpressions.Regex('\.(txt|cfg|conf|ini|csv|log|xml|java|c|cpp|cs)$', $regex_opts)
